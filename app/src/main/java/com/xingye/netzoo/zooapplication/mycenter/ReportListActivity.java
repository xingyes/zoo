...
import com.xingye.netzoo.zooapplication.medicreport.*;
...
public class ReportListActivity extends Activity{
    ...
    private ArrayList<ReportModel> results = new ArrayList<ReportModel>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        naviBar.setTitle(R.string.check_report);
        ...
        resultAdapter = new Result3tvAdapter(new Result3tvAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, Object tag) {
                ...
                bundle.putString(TitleImgActivity.TITLE_TXT,results.get(pos).formTitle());
                ...
                UiUtils.startActivity(ReportListActivity.this, TitleImgActivity.class,bundle,true);
            }
        });
